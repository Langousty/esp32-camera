...
typedef enum {
    ...
    FRAMESIZE_256X128_50MM,  // 256x128 zoom 50mm
    FRAMESIZE_256X128_75MM,  // 256x128 zoom 75mm
    FRAMESIZE_256X128_90MM,  // 256x128 zoom 90mm
    FRAMESIZE_256X128_135MM, // 256x128 zoom 135mm
    FRAMESIZE_256X128_200MM, // 256x128 zoom 200mm
    // END CUSTOM RES
...
typedef enum {
    ...
    ASPECT_RATIO_2X1_75,
    ASPECT_RATIO_2X1_90,
    ASPECT_RATIO_2X1_135,
    ASPECT_RATIO_2X1_200
